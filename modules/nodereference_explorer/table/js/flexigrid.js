		...
		var g = {
			...
			dragStart: function (dragtype,e,obj) { //default drag function start
				...
				if (dragtype=='colresize' && p.colResize == true) //column resize
                {
                        ...
                        this.colresize = {startX: e.pageX, ol: parseInt(obj.style.left),
ow: ow, n : n };
		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>Quick Search " +
						"<input type='text' size='30' name='q' class='qsbox'/> " +
...
//			$('input[name=q]',this.grid.sDiv).val(word);
//			$('select[name=qtype]',this.grid.sDiv).val("filename");
//			
